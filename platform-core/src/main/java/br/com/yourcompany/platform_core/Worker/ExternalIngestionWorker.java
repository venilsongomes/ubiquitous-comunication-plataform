...
import br.com.yourcompany.platform_core.repository.UserIdentityRepository;
...
public class ExternalIngestionWorker {
    ...
    // --- Simulação de Bot ---
    // Em um sistema real, isso viria de um DB ou config.
    // Use o ID de um usuário que você criou para "ser" o bot.
    ...
    private UserIdentity registerNewExternalUser(String platform, String externalId) {
        ...
        User newUser = new User("user_telegram_" + externalId, "Usuário do " + platform);
